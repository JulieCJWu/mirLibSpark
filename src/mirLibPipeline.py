...
if __name__ == '__main__' :
  ...
  for infile in infiles :
    ...
    print(datetime.datetime.now(), 'set13\t\tremoved sequences not dominating the expression within precursor range (expressions of their variants are considered)', 'remaining NB = ', len(set13))
